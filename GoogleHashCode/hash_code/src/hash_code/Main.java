...
public class Main {
	...
	public void calculateScore(List<Library> libList, Scanner submit, int libraries, int days) {
		// System.out.println(days);

		for (int library = 0; library < libraries; library++) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			submissionScanner = new Scanner(
					new File("C:/Users/DwarakeshwaranBM/Downloads/Hash Code/submissionFile.txt"));
			...
			main.calculateScore(libList, submissionScanner, main.scannedLibraries, main.NoOfDays);
